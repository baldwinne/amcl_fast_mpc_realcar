...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/handsfree/Amcl_LMPC_Fast_Real/src/Fast-Planner/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /home/handsfree/Amcl_LMPC_Fast_Real/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /home/handsfree/Amcl_LMPC_Fast_Real/install)
...
if(NOT "/home/handsfree/Amcl_LMPC_Fast_Real/devel/include " STREQUAL " ")
  set(multi_map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsfree/Amcl_LMPC_Fast_Real/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsfree/Amcl_LMPC_Fast_Real/src/Fast-Planner/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
