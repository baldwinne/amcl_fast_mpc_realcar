...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/handsfree/Amcl_LMPC_Fast_Real/src/Fast-Planner/uav_simulator/Utils/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/handsfree/Amcl_LMPC_Fast_Real/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/handsfree/Amcl_LMPC_Fast_Real/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsfree/Amcl_LMPC_Fast_Real/src/Fast-Planner/uav_simulator/Utils/rviz_plugins/${idir}'.  ${_report}")
    endif()
